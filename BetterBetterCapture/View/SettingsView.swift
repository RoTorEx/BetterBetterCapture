...
/// The settings window for BetterBetterCapture
...
struct ShortcutsSettingsView: View {
    var body: some View {
        Form {
            ...
            Section {
                Text("Shortcuts work globally, even when BetterBetterCapture is not focused.")
                    .font(.caption)
    ...
    var body: some View {
        Form {
            ...
            Section("Display Elements") {
                ...
                Toggle("Show BetterBetterCapture", isOn: $settings.showBetterBetterCapture)
            }
