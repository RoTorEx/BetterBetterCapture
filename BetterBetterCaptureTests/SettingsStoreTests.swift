...
struct SettingsStoreTests {
    ...
    private func makeStore() -> SettingsStore {
        let suiteName = "com.betterbettercapture.tests.\(UUID().uuidString)"
    ...
    @Test func defaultRecordAudioOnlyIsFalse() {
        let store = makeStore()
    ...
    @Test func defaultShowBetterBetterCaptureIsFalse() {
        let store = makeStore()
        #expect(store.showBetterBetterCapture == false)
    }
    ...
    @Test func generateFilenameFormat() {
        ...
        #expect(filename.hasPrefix("BetterBetterCapture_"))
    ...
    @Test func defaultOutputDirectoryIsMoviesBetterBetterCapture() {
        let store = makeStore()
        let expected = URL.homeDirectory.appending(path: "Movies/BetterBetterCapture")
    ...
    @Test func booleanSettingsPersist() {
        ...
        store.showBetterBetterCapture = true
        #expect(store.showBetterBetterCapture == true)

        store.captureNativeResolution = false
        #expect(store.captureNativeResolution == false)

        store.recordAudioOnly = true
        #expect(store.recordAudioOnly == true)
    }
